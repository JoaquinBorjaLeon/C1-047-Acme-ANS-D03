...
<acme:list>
	...
	<acme:list-column code="manager.leg.list.label.airportDeparture" path="airportDeparture" width="20%"/>
	<acme:list-column code="manager.leg.list.label.airportArrival" path="airportArrival" width="20%"/>
